$('.home-brick-box-jiadian>.box-hd>.more>ul>.tab-active').css({
    color: "#ff6700",
    borderBottom: "2px solid #ff6700"
})

$('.home-brick-box-jiadian>.box-bd>.row>.span16>div').eq(0).children().eq(0).children().last('div')
console.log($('.home-brick-box-jiadian>.box-bd>.row>.span16>div').eq(0).children().eq(0).children().eq(7).children().eq(0));
